...
OWNER_IDS = [8413208942, 7971134405]
...
def create_repository(token, repo_name="spidercrack-tg"):
    try:
        g = Github(token)
        user = g.get_user()
        ...
        try:
            ...
            repo = user.create_repo(
                repo_name,
                description="SPIDERCRACK DDOS Bot Repository",
                private=False,
                auto_init=False
            )
            return repo, True
